...
const consoles = [
  { label: "PlayStation 5", value: "Disponível", note: "Edição padrão e digital" },
  { label: "Xbox Series X", value: "Disponível", note: "Com controle e cabo HDMI" },
  { label: "Nintendo Switch", value: "Disponível", note: "OLED e versão padrão" },
  { label: "PlayStation 4 Pro", value: "Disponível", note: "1TB — excelente custo-benefício" },
];
    ...
    >
      <div className="mx-auto flex max-w-[1400px] flex-col gap-16 md:grid md:grid-cols-[5fr_4fr] md:gap-20">
        <AnimatedSection className="flex flex-col gap-8">
          <AnimatedItem>
            <EyebrowBadge>ELECTRO GAMES // CONSOLES</EyebrowBadge>
          </AnimatedItem>
          <AnimatedItem>
            <h2 className="max-w-[16ch] font-sans text-4xl font-semibold leading-[0.98] tracking-tighter text-foreground md:text-6xl">
              ...
              <span className="text-accent">direto pra você.</span>
            </h2>
          </AnimatedItem>
          <AnimatedItem>
            <p className="max-w-[48ch] font-sans text-base leading-relaxed text-zinc-400 md:text-lg">
              Trabalhamos com os principais consoles do mercado — novos e
              seminovos, todos testados, revisados e com garantia. Aqui você
              encontra o console certo pelo preço certo.
            </p>
          </AnimatedItem>
          <AnimatedItem>
            <a
